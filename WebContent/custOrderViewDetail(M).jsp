		    ...
		    <label class="col-sm-1 control-label">Order Date</label>
				 ...
				 <div class="line line-dashed line-lg pull-in"></div>
                  ...
                  <div class="form-group">
					...
					<br> 
                      <a href="updateCustomerOrderView(M).jsp?id=<%=custid%>"  class="btn btn-s-md btn-primary btn-rounded">Update</a>
                      <a href="customerdetails(M).jsp"  class="btn btn-s-md btn-primary btn-rounded">Ok</a>
