...
<html>
	...
	<title>Login | VeterinaryFamily</title>
	...
	<body class="pattern">
		<section id="content" class="m-t-lg wrapper-md animated fadeInUp"  style="margin-top: 0px;padding-top: 0px;">
 			 ...
 			 <center><img src="images\UPS.png"  style="width:300px;height:150px;"></center>
    			...
    			<br><center><font color ="red">Invalid Login. Please enter the user id and password again.</font></center>
     				 <form action="login1" class="panel-body wrapper-lg">
