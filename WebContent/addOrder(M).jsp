	  ...
	  padding-left:50px;">
            ...
            <div class="m-b-md">
             ...
             <section class="panel panel-default">
              <header class="panel-heading font-bold">Add Order Form</header>
              <div class="panel-body" style"
	      padding-right:0px;
	      padding-left:0px;">
                <form class="form-horizontal" name = "createOrder" action = "createOrderServletM">
                 <input type="hidden" name= "staffid" value=<%= currentManager.getstaffId() %>>
                <%
                      		while(result.next()){
		 ...
		 <div class="form-group">
				   ...
				   <div class="line line-dashed line-lg 
...
pull-in"></div>
                    ...
                    <div class="col-sm-2">
                      ...
                      <input type="text" class="form-control"   readonly="readonly" name = "custid" value="<%= result.getString("customerid") %>" >
                    </div>
                    <label class="col-sm-2 control-label">Order ID</label>
                    <div class="col-sm-2">
                     
                      <input type="text" class="form-control"   readonly="readonly" name = "bookid" value=PT<%=1000 + (int) (Math.random() * 1000)%>  readonly="readonly" >
                    </div>
...
<div class="form-group">
				 ...
				 <div class="line line-dashed line-lg pull-
