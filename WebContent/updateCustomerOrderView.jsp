...
<footer class="footer lt hidden-xs b-t b-dark">
	  ...
	  padding-left:100px;">
            ...
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
              <li><a href="index.html"><i class="fa fa-home"></i>Owner and Pet Management</a></li>
            </ul>
            <div class="m-b-md">
             
             <section class="panel panel-default">
              <header class="panel-heading font-bold">Update Owner and Pet Form</header>
              <div class="panel-body" style"
              width:1000px;
	      padding-right:40px;
	      padding-left:60px;">
	      
                <form class="form-horizontal" name = "registration" action ="custOrderUpdateServlet" method="get">
                 <%
                      		while(result.next()){
