...
<head>
<meta charset="utf-8" />
<title>Customer & Order Information Listing| VeterinaryFamily</title>
...
%>
	...
	try{
		...
		Class.forName("oracle.jdbc.driver.OracleDriver"); 
			...
			qry = "SELECT C.CUSTOMERID, C.CUSTOMERNAME, C.CUSTOMERADDRESS, C.CUSTOMERPHONENO, C.CUSTOMEREMAIL, B.BOOKID, B.BOOKDATE, B.COLLECTDATE FROM CUSTOMER C INNER JOIN BOOKING B ON C.CUSTOMERID = B.CUSTOMERID";
                     ...
                     <!--       <th width="110">Breed</th>
                      ...
                      <tbody>
                      	...
                      	<tr>
                      		...
                      		<td><%=result.getString("customeraddress")%></td>
                      		<td><%=result.getString("customerphoneno")%></td>
  							...
  							<td><a href="custOrderViewDetail(M).jsp?id=<%=custid%>"><i class="fa fa-eye"></i></a> <a href="updateCustomerOrderView(M).jsp?id=<%=custid%>"><i class="fa fa-pencil"></i></a> <a href="deleteCustOrder.jsp?id=<%=custid%>" onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-eraser"></i></a>  
                      	</tr>
                      	<%
                      		}
                      	%>
